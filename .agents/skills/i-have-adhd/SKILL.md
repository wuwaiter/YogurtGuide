...
Source: https://github.com/MyFavoriteForkedRepo/i-have-adhd (MIT). Condensed always-on version lives in this repo's `AGENTS.md`. This file is the full reference.

In this project, all user-facing output stays in Traditional Chinese; these rules govern shape, not language.
...
## Project-specific notes (YogurtGuide)
